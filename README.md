# PaulMcInnis.github.io

A simple, responsive, single-page portfolio and resume built with Bulma, Sass, Font Awesome and Flickity. Built to run on both desktop and mobile devices.
